...
"""
from femexamples import opensees_cantilever_std as canti
...
def setup_cantileverbase(doc=None, solvertype="opensees"):
    ...
    if solvertype == "calculix":
        ...
        analysis.addObject(ObjectsFem.makeSolverOpenSees(doc, "SolverOpneSees"))
...
def setup_cantileverfaceload(doc=None, solvertype="opensees"):
...
def setup_cantilevernodeload(doc=None, solvertype="opensees"):
...
def setup_cantileverprescribeddisplacement(doc=None, solvertype="opensees"):
...
def setup_cantileverhexa20faceload(doc=None, solvertype="opensees"):
